...
@section('content')
  ...
  <div class="grid">
    ...
    <form action="{{ route('resAuth.login') }}" method="POST" class="form login">
      @csrf
  ...
  <p class="text--center">Not a member? <a href="{{ url('/restaurant/register') }}">Sign up now</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
  @if (count($errors) > 0)
